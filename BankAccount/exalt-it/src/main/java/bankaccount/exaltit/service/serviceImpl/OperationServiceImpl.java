...
public class OperationServiceImpl implements OperationService {
	 ...
	 * "Une operation ne peut pas contenir un nombre négatif.
	 * Une operation ne doit contenir qu'un seul nombre possitif soit au debit ou au credit"
	 * 
	...
	public Operation save(Operation operation, Long clientID, Long compteID) throws ExceptionIllegalOperation, ExceptionNotEnough {
		// Le cas d'une operation invalide
		...
		solde += operation.getCredit() > 0 ? operation.getCredit() : -operation.getDebit();
		if(solde<0) {
			throw new ExceptionNotEnough("Cette operation n'est pas possible vous n'avez pas assez d'avoir pour cette operation");
		}
